...
RegisterNetEvent('es:setExperienceIcon')
AddEventHandler('es:setExperienceIcon', function(i)
	SendNUIMessage({
		seticon = true,
		icon = i
	})
...
AddEventHandler('es:activateExperience', function(e)
	SendNUIMessage({
		setexperience = true,
		experience = e
	})
...
RegisterNetEvent('es:displayExperience')
AddEventHandler('es:displayExperience', function(a)
	enableNative[3] = true

	-- Found by FiveM forum user @Lobix300
	N_0xc2d15bef167e27bc()
	SetPlayerExperienceChange(0, 1)
	Citizen.InvokeNative(0x170F541E1CADD1DE, true)
	SetPlayerExperienceChange(0, a)
end)

RegisterNetEvent("es:addedExperience")
AddEventHandler("es:addedExperience", function(m, native)
...
RegisterNetEvent("es:removedExperience")
AddEventHandler("es:removedExperience", function(m, native, current)
	if not native then
		SendNUIMessage({
...
RegisterNetEvent("es:setExperienceDisplay")
AddEventHandler("es:setExperienceDisplay", function(val)
	SendNUIMessage({
		setDisplay = true,
		display = val
	})
