function CreateExtendedPlayer(player, accounts, inventory, job, loadout, name, lastPosition)
  ...
  self.setExperience = function(m)
    self.player.setExperience(m)
  end

  self.getExperience = function()
    return self.player.get('experience')
  end
  ...
  self.addExperience = function(m)
    self.player.addExperience(m)
  end

  self.removeExperience = function(m)
    self.player.removeExperience(m)
  end 
  ...
  self.displayMoney = function(m)
   ...
   self.displayExperience = function(m)
    self.player.displayExperience(m)
  end 
